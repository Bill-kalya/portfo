...
const ExperienceCard = ({ backText, badge, title, footer }) => {
  return (
    <div className="experience-card">
      <div className="content">
        <div className="back">
          <div className="back-content">
            <svg stroke="#ffffff" xmlns="http://www.w3.org/2000/svg" 
              ...
              <div className="title">
                ...
                <svg fillRule="nonzero" height="15px" width="15px" viewBox="0,0,256,256" 
                  ...
                  <g style={{ mixBlendMode: 'normal' }} 
                     strokeDashoffset="0" strokeDasharray="" strokeMiterlimit="10" 
                     strokeLinejoin="miter" strokeLinecap="butt" strokeWidth="1" 
                     stroke="none" fillRule="nonzero" fill="#20c997">
  ...
  return (
    <div className="experience-container">
      <ExperienceCard 
        ...
        footer="30 Mins | 1 Serving" 
      />
      <ExperienceCard 
        backText="Just Trying" 
        badge="Dessert" 
        title="Chocolate Mousse" 
        footer="20 Mins | 4 Servings" 
      />
    </div>
  );
};
