        ...
        <div className="loader-container">
            ...
            <div className="holo-sphere">
              ...
              <div className="holo-particles">
                {Array.from({ length: 12 }).map((_, i) => (
                  <div className="holo-particle" key={i}></div>
                ))}
              </div>
            </div>
          ...
          <div className="code-lines">
            <div className="code-line">
              ...
              01001001 01011010 01001001 01001110 01000111
            </div>
            <div className="code-line">
            ...
            <div className="code-line">
              class QuantumProcessor {"{"} constructor() {"{"} this.entanglement =
              new Map(); {"}"} {"}"}
            </div>
            <div className="code-line">
              01010010 01000101 01001110 01000100 01000101 01010010 01001001
              01001110 01000111 00100000 01001000 01001111 01001100 01001111
            </div>
            <div className="code-line">
            ...
            <div className="code-line">
              ...
              01001001 01001110 01000111 00100000 01000100 01000001 01010100
              01000001
            </div>
            <div className="code-line">
              async function loadHolographicData() {"{"} await
              fetch('/api/quantum'); {"}"}
            </div>
          </div>
          ...
          <div className="loading-text">COLLECTING INFORMATION</div>
